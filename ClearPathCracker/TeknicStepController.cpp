...
/* This is the minimum constructor for TeknicStepController it requires a pointer to one PulseClearPath, or
...
*/
TeknicStepController::TeknicStepController(PulseClearPath* motor1)
{
	_SUMPINS=0;
	_flag=false;
   _numAxis=1;
...
/* This is a constructor for TeknicStepController, it requires 2 pointer to PulseClearPath, or
...
*/
TeknicStepController::TeknicStepController(PulseClearPath* motor1, PulseClearPath* motor2)
{
	_SUMPINS=0;
	_flag=false;
   _numAxis=2;
...
/* This is a constructor for TeknicStepController, it requires 3 pointer to PulseClearPath, or
	StepClearPath motors.  It requires pointers because this class must use the functions of the
	same ClearPath objects used in the main routine.
	...
	NOTE: the DirPins of the passed motor must each be one different of pins 8-13
*/
TeknicStepController::TeknicStepController(PulseClearPath* motor1, PulseClearPath* motor2, PulseClearPath* motor3)
{
	_SUMPINS=0;
	_flag=false;
   _numAxis=3;
...
/* This is a constructor for TeknicStepController, it requires 4 pointer to PulseClearPath, or
	StepClearPath motors.  It requires pointers because this class must use the functions of the
	same ClearPath objects used in the main routine.
	...
	NOTE: the DirPins of the passed motor must each be one different of pins 8-13
*/
TeknicStepController::TeknicStepController(PulseClearPath* motor1, PulseClearPath* motor2, PulseClearPath* motor3, PulseClearPath* motor4)
{
	_SUMPINS=0;
	_flag=false;
   _numAxis=4;
...
/* This is a constructor for TeknicStepController, it requires 5 pointer to PulseClearPath, or
	StepClearPath motors.  It requires pointers because this class must use the functions of the
	same ClearPath objects used in the main routine.
	...
	NOTE: the DirPins of the passed motor must each be one different of pins 8-13
*/
TeknicStepController::TeknicStepController(PulseClearPath* motor1, PulseClearPath* motor2, PulseClearPath* motor3, PulseClearPath* motor4, PulseClearPath* motor5)
{
	_SUMPINS=0;
	_flag=false;
   _numAxis=5;
...
/* This is a constructor for TeknicStepController, it requires 6 pointer to PulseClearPath, or
	StepClearPath motors.  It requires pointers because this class must use the functions of the
	same ClearPath objects used in the main routine.
	...
	NOTE: the DirPins of the passed motor must each be one different of pins 8-13
*/
TeknicStepController::TeknicStepController(PulseClearPath* motor1, PulseClearPath* motor2, PulseClearPath* motor3, PulseClearPath* motor4, PulseClearPath* motor5, PulseClearPath* motor6)
{
	_SUMPINS=0;
	_flag=false;  
   _numAxis=6;
...
*/
void TeknicStepController::Start(int time)
{
	_SUMPINS=0;
	for( int i=0; i<_numAxis; i++)
   {
...
*/
void TeknicStepController::Stop()
{
	cli();//stop interrupts
//   
   // set up Timer 1
...
int TeknicStepController::getsum()
{
